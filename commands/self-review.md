...
description: Automated code review with parallel agents and confidence scoring
...
<link to file and line with full sha1 + line range for context, note that you MUST provide the full sha and not use bash here, eg. https://github.com/your-org/your-repo/blob/abc123full-sha/README.md#L13-L17>
...
- When linking to code, use GitHub permalink format precisely, otherwise Markdown won't render correctly:
  `https://github.com/{owner}/{repo}/blob/{full-sha}/{path}#L{start}-L{end}`
  - Example: `https://github.com/your-org/your-repo/blob/abc123full-sha/package.json#L10-L15`
  - Use the full 40-character git SHA — short refs and shell expansions like `$(git rev-parse HEAD)` won't work since the comment is rendered as static Markdown
  - Repo name must match the repo you're reviewing
  - Include at least 1 line of context before and after (e.g., if commenting on lines 5-6, link to `L4-L7`)
